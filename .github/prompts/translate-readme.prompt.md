...
- Users will edit [README.zh-CN.md](../../README.zh-CN.md) in Chinese as the source. If the file is unchanged in the Git workspace, no action is needed.
- If the source file has changes, translate only the modified parts to English and update the [README.md](../../README.md) file in the same directory.
